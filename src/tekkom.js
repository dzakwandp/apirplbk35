...
export default class tekkom extends Component {
    ...
    handleDelete = (id) => {
        ...
        if (proceed) {
            axios({
                method: "delete",
                url: "https://apirplbk35.herokuapp.com/data/del/"+id,
                headers: {
                accept: "*/*"
                }
                })
    ...
    handleSubmit = () => {
        ...
        !this.state.tahun !== ""
            ...
            axios({
                method: "post",
                url: "https://apirplbk35.herokuapp.com/data/post",
                headers: {
                accept: "*/*",
                },
                data: {
    ...
    componentDidMount() {
        axios({
            method: "get",
            url: "https://apirplbk35.herokuapp.com/data",
            headers: {
            accept: "*/*",
            },
        })
    ...
    render() {
        ...
        <center>
        <button onClick={this.handleTambahOrang}
                style={{marginTop:'3%'}}>Tambah Game</button>
        <br></br><br/>
        ...
        return (
        <div className="card" key={results.nama} style={{display:'flex', flexDirection:'row', width:'100%', marginBottom:'3%'}}>
        ...
        <button
        className="button"
        onClick={() => this.handleButton(results._id)}
        >
        Lihat ID
        </button>
